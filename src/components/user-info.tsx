...
const UserInfo = () => {
  ...
  const userInfo = {
    ...
    photo: user?.photo || "https://t4.ftcdn.net/jpg/02/24/86/95/360_F_224869519_aRaeLneqALfPNBzg0xxMZXghtvBXkfIA.jpg",
  };

  return (
    <div className="bg-white/80   rounded-xl border border-white/30 p-5 w-full max-w-sm     mx-auto">
